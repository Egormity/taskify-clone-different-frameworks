import { Add, HelpOutline, HorizontalRule, Person2Outlined } from "@mui/icons-material";
		...
		<>
			<div>
				...
				<div className="mt-6 flex flex-wrap gap-4">
					...
					{/*  */}
					<Button
						className="relative flex h-36 w-64 flex-col items-center justify-center overflow-hidden rounded-lg text-center"
						onClick={toggleOpen}
					>
